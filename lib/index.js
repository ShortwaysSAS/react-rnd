...
var Draggable = require("shortways-react-draggable");
var resizableStyle = {
    width: "auto",
    height: "auto",
...
var Rnd = /** @class */ (function (_super) {
    ...
    Rnd.prototype.onDragStart = function (e, data) {
        ...
        if (this.props.bounds === "parent") {
            ...
            //--------------------------------------------------------------------------------
            var left_2 = this.props.position && this.props.position.anchor.isLeft
                ? -(parentLeft_2 - parent.offsetLeft * scale) / scale
                : +(parentLeft_2 - parent.offsetLeft * scale - this.resizable.size.width * scale) / scale;
            var top_2 = this.props.position && this.props.position.anchor.isTop
                ? -(parentTop_2 - parent.offsetTop * scale) / scale
                : +(parentTop_2 - parent.offsetTop * scale - this.resizable.size.height * scale) / scale;
            var right = this.props.position && this.props.position.anchor.isLeft
                ? (window.innerWidth - this.resizable.size.width * scale) / scale + left_2
                : -window.innerWidth / scale + (parentLeft_2 - parent.offsetLeft * scale) / scale;
            var bottom = this.props.position && this.props.position.anchor.isTop
                ? (window.innerHeight - this.resizable.size.height * scale) / scale + top_2
                : -window.innerHeight / scale + (parentTop_2 - parent.offsetTop * scale) / scale;
            //--------------------------------------------------------------------------------
