...
var Rnd = /** @class */ (function (_super) {
    ...
    Rnd.prototype.onDragStart = function (e, data) {
        ...
        if (this.props.bounds === "parent") {
            ...
            var left_2 = +(parentLeft_2 - parent.offsetLeft * scale - this.resizable.size.width * scale) / scale;
            var top_2 = +(parentTop_2 - parent.offsetTop * scale - this.resizable.size.height * scale) / scale;
            var right = -window.innerWidth / scale + (parentLeft_2 - parent.offsetLeft * scale) / scale;
            var bottom = -window.innerHeight / scale + (parentTop_2 - parent.offsetTop * scale) / scale;
            console.log({ top: top_2, right: right, bottom: bottom, left: left_2 });
